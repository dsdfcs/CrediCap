...
def compute_human_correlation(ann_file, args, tauvariant='c'):
    ...
    our_scores = []
    for idx, (image_file, candidate, reference) in enumerate(zip(tqdm(img_list), txt_list, gt_list)):
        if idx % 3 == 0:
            ...
            try:
                dotsnumbersdots = re.sub(r'[^\d.]', '', outputs[:-4])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--base_fold", default='./annotations', help="annotation file folder")
